  ...
  return (
    <header className="sticky top-0  z-[100] h-20  border-b border-[var(--bd)] px-[clamp(1.5rem,6vw,5rem)] flex items-center justify-between shadow-sm bg-white">
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2 px-7 py-3 rounded-full bg-[var(--tx)] text-white text-[0.85rem] font-bold transition-all hover:bg-[var(--gn)] hover:scale-[1.02] active:scale-[0.98]">
          Apply Now
